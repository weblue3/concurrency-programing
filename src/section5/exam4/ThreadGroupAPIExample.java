...
public class ThreadGroupAPIExample {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        System.out.println("메인그룹 활성 스레드 수:: " + Thread.currentThread().getThreadGroup().activeCount());
        System.out.println("메인그룹 활성 스레드 그룹 수 " + Thread.currentThread().getThreadGroup().activeGroupCount());
        System.out.println("======= 메인 스레드 그룹에 포함 된 정보 출력 START ===============");
        Thread.currentThread().getThreadGroup().list();
        System.out.println("======= 메인 스레드 그룹에 포함 된 정보 출력 END ===============");
